...
def train_model(
    ...
    train_loader = DC.DataLoader(train_set, batch_size=32, shuffle=True, num_workers=16, pin_memory=True)
    val_loader = DC.DataLoader(val_set, batch_size=32, shuffle=False, drop_last=True, num_workers=16, pin_memory=True)
