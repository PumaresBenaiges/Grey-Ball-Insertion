...
if __name__ == '__main__':
    # Load dataframes
    ball_data = pd.read_csv('ball_data_new.csv')
    ...
    for batch_idx, (input_images, input_cropped, output_cropped, mask) in enumerate(dataloader):
        print(mask.max())
        ...
        vutils.save_image(output_cropped[:, :3, :, :], 'output_samples.png', normalize=True)
